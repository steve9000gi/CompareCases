...
// .NAME ccChartXY - Factory class for drawing XY charts
//
// .SECTION Description
// This class implements an XY chart.  It's vtkChartXY (from VTK 5.6.1),
// copied and modified for the special needs of CaseSpaceDialog.

#ifndef __ccChartXY_h
#define __ccChartXY_h
...
class ccChartXYPrivate; // Private class to keep my STL vector in...

class VTK_CHARTS_EXPORT ccChartXY : public vtkChartXY
{
public:
  vtkTypeMacro(ccChartXY, vtkChartXY);
  virtual void PrintSelf(ostream &os, vtkIndent indent);

  // Description:
  // Creates a 2D Chart object.
  static ccChartXY *New();

  void SetCaseSpaceDialog(CaseSpaceDialog *csd) { caseSpaceDialog = csd; }; // SAC
  void SetXShift(float xS) { xShift = xS; }; // SAC 2011/03/24
  void SetYShift(float yS) { yShift = yS; }; // SAC 2011/03/24
  ...
  virtual vtkPlot * AddPlot(int type, int markerStyle = vtkPlotPoints::SQUARE); // SAC 2011/03/15
...
//BTX
  ...
  // begin SAC 2011/03/09
  vtkVector2f GetSelectedPlotPos() { return selectedPlotPos; };
  vtkPlot *GetSelectedPlot() { return selectedPlot; };
  // end SAC 2011/03/09
...
protected:
  ...
  // begin SAC 2011/03/09
  vtkVector2f selectedPlotPos;
  vtkPlot *selectedPlot;

  CaseSpaceDialog *caseSpaceDialog;
  // end SAC 2011/03/09

  float xShift; // SAC 2011/03/24
  float yShift; // SAC 2011/03/24
...
private:
  ccChartXY(const ccChartXY &); // Not implemented.
  void operator=(const ccChartXY &);   // Not implemented.

  ccChartXYPrivate *ChartPrivate; // Private class where I hide my STL containers
